...
if("FALSE" STREQUAL "TRUE")
  set(project_SOURCE_PREFIX /home/m/mico2178/baxter_ws/src/project)
  set(project_DEVEL_PREFIX /home/m/mico2178/baxter_ws/devel)
  set(project_INSTALL_PREFIX "")
  set(project_PREFIX ${project_DEVEL_PREFIX})
else()
  set(project_SOURCE_PREFIX "")
  set(project_DEVEL_PREFIX "")
  set(project_INSTALL_PREFIX /home/m/mico2178/baxter_ws/install)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/m/mico2178/baxter_ws/install/${idir}'.  Ask the maintainer 'mico2178 <mico2178@todo.todo>' to fix it.")
    endif()
