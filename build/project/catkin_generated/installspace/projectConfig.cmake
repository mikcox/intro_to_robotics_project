...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/colab/ros/ws_baxter/src/cox_campuzano_ian_project/intro_to_robotics_project/install/${idir}'.  Ask the maintainer 'mico2178 <mico2178@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/colab/ros/ws_baxter/src/cox_campuzano_ian_project/intro_to_robotics_project/install/lib;/home/colab/ros/ws_baxter/devel/lib;/opt/ros/hydro/lib)
