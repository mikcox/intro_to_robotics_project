...
if("FALSE" STREQUAL "TRUE")
  set(baxter_ikfast_right_arm_plugin_SOURCE_PREFIX /home/m/mico2178/baxter_ws/src/baxter/baxter_ikfast_right_arm_plugin)
  set(baxter_ikfast_right_arm_plugin_DEVEL_PREFIX /home/m/mico2178/baxter_ws/devel)
  ...
  set(baxter_ikfast_right_arm_plugin_INSTALL_PREFIX /home/m/mico2178/baxter_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_ikfast_right_arm_plugin' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'dave <dave@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_ikfast_right_arm_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/m/mico2178/baxter_ws/install/${idir}'.  Ask the maintainer 'dave <dave@todo.todo>' to fix it.")
    endif()
